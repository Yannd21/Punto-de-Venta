...
public class UserManager {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (datos.length >= 3) {
                    ...
                    String rol = datos.length > 4 ? datos[4].trim() : "CAJERO";

                    usuarios.add(new Usuario(username, password, nombreCompleto, email, rol));
                }
            }
        } catch (IOException e) {
    ...
    private void crearUsuariosPorDefecto() {
        usuarios.clear();
        usuarios.add(new Usuario("admin", "admin123", "Administrador", "admin@tpv.com", "ADMIN"));
        usuarios.add(new Usuario("cajero1", "cajero123", "Juan Pérez", "juan@tpv.com", "CAJERO"));
        usuarios.add(new Usuario("cajero2", "cajero123", "María García", "maria@tpv.com", "CAJERO"));
    }
